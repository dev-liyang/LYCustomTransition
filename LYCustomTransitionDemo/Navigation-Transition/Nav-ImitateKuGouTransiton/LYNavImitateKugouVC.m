...
#import "LYNavImitateKugouSecondVC.h"
#import "LYNavImitateKuGouAnimationTransition.h"

@interface LYNavImitateKugouVC ()

@property (nonatomic, strong) LYNavImitateKuGouAnimationTransition *animatedTransition;

@property (nonatomic, strong) UIImageView         *imgView;

@end

@implementation LYNavImitateKugouVC
...
- (void)pushSecond{
    ...
    //2.push跳转
    LYNavImitateKugouSecondVC *second = [[LYNavImitateKugouSecondVC alloc] init];
    [self.navigationController pushViewController:second animated:YES];
}


- (LYNavImitateKuGouAnimationTransition *)animatedTransition{
    if (!_animatedTransition) {
        _animatedTransition = [[LYNavImitateKuGouAnimationTransition alloc] init];
    }
