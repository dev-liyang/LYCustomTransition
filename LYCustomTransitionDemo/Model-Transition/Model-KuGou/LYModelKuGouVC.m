...
#import "LYModelKuGouSecondVC.h"
#import "LYModelKuGouAnimationTransition.h"

@interface LYModelKuGouVC ()

@property (nonatomic, strong) LYModelKuGouAnimationTransition *animatedTransition;

@property (nonatomic, strong) UIImageView         *imgView;

@end

@implementation LYModelKuGouVC
...
- (void)pushSecond{
    ...
    LYModelKuGouSecondVC *second = [[LYModelKuGouSecondVC alloc] init];
...
- (LYModelKuGouAnimationTransition *)animatedTransition{
    if (!_animatedTransition) {
        _animatedTransition = [[LYModelKuGouAnimationTransition alloc] init];
    }
