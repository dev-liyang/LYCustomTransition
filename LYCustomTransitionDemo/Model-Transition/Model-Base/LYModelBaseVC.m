...
#import "LYModelBaseSecondVC.h"
#import "LYNavBaseCustomAnimator.h"

@interface LYModelBaseVC () <UIViewControllerTransitioningDelegate>
...
- (void)presentSecond{
    ...
    LYModelBaseSecondVC *second = [[LYModelBaseSecondVC alloc] init];
